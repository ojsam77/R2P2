...
function init() {
  ...
  water = new Water(
    waterGeometry,
    {
      textureWidth: 512,
      textureHeight: 512,
      waterNormals: new THREE.TextureLoader().load('./src/assets/threejs_lotus/threejs_water-texture.webp', function (texture) {
  ...
  dracoLoader.setDecoderPath('./src/assets/threejs_lotus/draco/'); // Set the correct path to the Draco decoder
  loader.setDRACOLoader(dracoLoader);

  loader.load('./src/assets/threejs_lotus/threejs_lotus-model.glb', function (gltf) {
    model = gltf.scene;
    group.add(model);
  ...
  function loadPistils() {
    ...
    loader.load('./src/assets/threejs_lotus/threejs_pistil-model.glb', function (gltf) {
